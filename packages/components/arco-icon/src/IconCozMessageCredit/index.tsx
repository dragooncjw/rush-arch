...
function IconCozMessageCreditComponent(
  ...
  return (
    <svg
      className={`${prefix}-icon ${prefix}-icon-coz_message_credit${loadingKls} ${className}`}
      width={width}
      height={height}
      viewBox="0 0 24 24"
