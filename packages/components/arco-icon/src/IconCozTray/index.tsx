...
function IconCozTrayComponent(
  ...
  return (
    <svg
      className={`${prefix}-icon ${prefix}-icon-coz_tray${loadingKls} ${className}`}
      width={width}
      height={height}
      viewBox="0 0 24 24"
