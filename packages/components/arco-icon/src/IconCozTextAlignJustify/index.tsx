...
function IconCozTextAlignJustifyComponent(
  ...
  return (
    <svg
      className={`${prefix}-icon ${prefix}-icon-coz_text_align_justify${loadingKls} ${className}`}
      width={width}
      height={height}
      viewBox="0 0 24 24"
...
const IconCozTextAlignJustify = React.forwardRef(
  IconCozTextAlignJustifyComponent,
);
