...
function IconCozMicrophoneSlashFillComponent(
  ...
  return (
    <svg
      className={`${prefix}-icon ${prefix}-icon-coz_microphone_slash_fill${loadingKls} ${className}`}
      width={width}
      height={height}
      viewBox="0 0 24 24"
...
const IconCozMicrophoneSlashFill = React.forwardRef(
  IconCozMicrophoneSlashFillComponent,
);
