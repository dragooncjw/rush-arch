...
function IconCozPaddingBottomComponent(
  ...
  return (
    <svg
      className={`${prefix}-icon ${prefix}-icon-coz_padding_bottom${loadingKls} ${className}`}
      width={width}
      height={height}
      viewBox="0 0 24 24"
      ...
      ref={ref}
    >
      <path d="M7 16C6.44772 16 6 16.4477 6 17C6 17.5523 6.44772 18 7 18H17C17.5523 18 18 17.5523 18 17C18 16.4477 17.5523 16 17 16H7Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
