...
function IconCozWarningCircleFillComponent(
  ...
  return (
    <svg
      className={`${prefix}-icon ${prefix}-icon-coz_warning_circle_fill${loadingKls} ${className}`}
      width={width}
      height={height}
      viewBox="0 0 24 24"
...
const IconCozWarningCircleFill = React.forwardRef(
  IconCozWarningCircleFillComponent,
);
