...
function IconCozFileVideoComponent(
  ...
  return (
    <svg
      className={`${prefix}-icon ${prefix}-icon-coz_file_video${loadingKls} ${className}`}
      width={width}
      height={height}
      viewBox="0 0 36 36"
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M9.66699 15.917C9.66699 15.2266 10.2266 14.667 10.917 14.667H19.667C20.3573 14.667 20.917 15.2266 20.917 15.917V17.4014L22.8042 16.3398C23.6374 15.8711 24.667 16.4733 24.667 17.4293V23.1547C24.667 24.1107 23.6374 24.7129 22.8042 24.2442L20.917 23.1826V24.667C20.917 25.3573 20.3573 25.917 19.667 25.917H10.917C10.2266 25.917 9.66699 25.3573 9.66699 24.667V15.917ZM13.417 19.667C14.1073 19.667 14.667 19.1073 14.667 18.417C14.667 17.7266 14.1073 17.167 13.417 17.167C12.7266 17.167 12.167 17.7266 12.167 18.417C12.167 19.1073 12.7266 19.667 13.417 19.667Z"
        fill={useCurrentColor ? 'currentColor' : '#fff'}
      />
    </svg>
  );
